...
class CType(Instruction):
    ...
    funcs = {
        # C0
        "00": {
            "010": {"name": "c.lw", "immBits": [[[5, 3]], [2, 6]]},
            "011": {"name": "c.ld", "immBits": [[[5, 3]], [[7, 6]]]},
            "001": {"name": "c.lq", "immBits": [[[5, 4], 8], [[7, 6]]]},
            ...
            "101": {"name": "c.sq", "immBits": [[[5, 4], 8], [[7, 6]]]},
        },
        # C1
        ...
        "01": {
            "101": {"name": "c.j", "immBits": [11, 4, [9, 8], 10, 6, 7, [3, 1], 5]},
            "001": {"name": "c.jal", "immBits": [11, 4, [9, 8], 10, 6, 7, [3, 1], 5]},
            "110": {"name": "c.beqz", "immBits": [[8, [4, 3]], [[7, 6], [2, 1], 5]]},
            "111": {"name": "c.bnez", "immBits": [[8, [4, 3]], [[7, 6], [2, 1], 5]]},
            "010": {"name": "c.li", "immBits": [[5], [[4, 0]]]},
            "011": {"name": "c.lui", "immBits": [[17], [[16, 12]]]},
            "000": {
                "name": "c.addi",
            },
            "001": {
        ...
        "10": {
            ...
            "001": {"name": "c.fldsp", "immBits": [[5], [[4, 3], [8, 6]]]},
            "110": {"name": "c.swsp", "immBits": [[5, 2], [7, 6]]},
            "111": {"name": "c.fswsp", "immBits": [[5, 2], [7, 6]]},
            "101": {"name": "c.fsdsp", "immBits": [[5, 3], [8, 6]]},
            "1000": {
                "name": "c.jr",
            },
            "1001": {
